...
CREATE TABLE `tbl_yearlevel` (
  ...
  UNIQUE KEY `yearLevel_UNIQUE` (`yearLevel`)
...
LOCK TABLES `tbl_yearlevel` WRITE;
/*!40000 ALTER TABLE `tbl_yearlevel` DISABLE KEYS */;
INSERT INTO `tbl_yearlevel` VALUES (1,'1'),(2,'2'),(3,'3'),(4,'4');
/*!40000 ALTER TABLE `tbl_yearlevel` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-04-02  1:11:42
